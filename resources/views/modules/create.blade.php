...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Create Module - Progress Tracking</title>
                    ...
                    <div class="col-lg-6">
                        <div class="card-custom p-5">
                            <div class="text-center mb-5">
                                <h1 class="display-5 fw-bold heading-gradient mb-3">Create Module</h1>
                                <p class="mb-0" style="color: #4b5563;">Create a new module to organize your tasks</p>
                            </div>
